...
function checkWinner(){
    ...
    if(square5.innerHTML !== "-" && square1.innerHTML !== "-" && square2.innerHTML !== "-" && square3.innerHTML !== "-"
    && square4.innerHTML !== "-" && square6.innerHTML !== "-" && square7.innerHTML !== "-" && square8.innerHTML !== "-"
    && square9.innerHTML !== "-"){
        winner = "Empatou! O_o";
...
function changeWinner(squareWinner){
